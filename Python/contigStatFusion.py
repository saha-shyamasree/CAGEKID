...
for infile in files: #glob.glob('blast/*.out'):
    if os.path.getsize(infile)>0:
        ...
        out_handle.write("file,query_name,query_length,match,hit_def,hit_length,e-value,p-value,identitie,align_length,gap,good_match,long_match,score,more,seq,sseq,s_st,s_end\n")
